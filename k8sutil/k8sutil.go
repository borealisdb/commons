...
import (
	...
	apiborealisdbv1 "github.com/borealisdb/commons/borealisdb.io/v1"
	borealisdbv1client "github.com/borealisdb/commons/generated/clientset/versioned"
	borealisdbv1 "github.com/borealisdb/commons/generated/clientset/versioned/typed/borealisdb.io/v1"
...
type KubernetesClient struct {
	...
	borealisdbv1.PostgresqlsGetter
	borealisdbv1.BorealisClusterAccountsGetter
	v1beta1metrics.PodMetricsesGetter
	v1beta1metrics.NodeMetricsesGetter

	RESTClient            rest.Interface
	BorealisdbV1ClientSet *borealisdbv1client.Clientset
}
...
func NewFromConfig(cfg *rest.Config) (KubernetesClient, error) {
	...
	kubeClient.BorealisdbV1ClientSet = borealisdbv1client.NewForConfigOrDie(cfg)
	kubeClient.PostgresqlsGetter = kubeClient.BorealisdbV1ClientSet.BorealisdbV1()
	kubeClient.BorealisClusterAccountsGetter = kubeClient.BorealisdbV1ClientSet.BorealisdbV1()

	return kubeClient, nil
}

// SetPostgresCRDStatus of Postgres cluster
func (client *KubernetesClient) SetPostgresCRDStatus(clusterName NamespacedName, status string) (*apiborealisdbv1.Postgresql, error) {
	var pg *apiborealisdbv1.Postgresql
	var pgStatus apiborealisdbv1.PostgresStatus
